...
if (isMainModule(import.meta.url) || process.env['pm_id']) {
    ...
    app.listen(port, (error) => {
        ...
        console.log(`🏡 Landscape Architect client listening on http://localhost:${port}`);
        console.log(`🌳 Connecting to Landscape Architect agent at http://localhost:10003`);
    });
}
...
async function createOrGetClient() {
    // Create a client pointing to the Landscape Architect agent's Agent Card URL (port 10003).
